...
function TailwindState() {
  return (
    <GradientSurface centered className="p-10">
      <button className="group relative h-13 w-40 cursor-pointer overflow-hidden rounded-full bg-linear-to-br from-blue-500 to-blue-600 text-white duration-200 ease-in-out hover:bg-white/20 active:scale-90 dark:from-slate-700 dark:to-slate-900">
