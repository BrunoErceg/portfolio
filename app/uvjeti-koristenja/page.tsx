...
export default function uvjetiKoristenja() {
  return (
    <section className="mx-5 mt-10 lg:mx-[25%]">
      <div className="mb-10">
        <Heading level={2} centered={false} className="mb-3">
          Uvjeti korištenja i Zaštita podataka (GDPR)
        </Heading>
      ...
      <div className="space-y-10">
        <div>
          ...
          <Text>
            Korištenjem ovog portfolia pristajete na ove uvjete. Sadržaj je informativnog karaktera
            i služi kao prezentacija mojih radova.
          </Text>
        </div>
        <div>
