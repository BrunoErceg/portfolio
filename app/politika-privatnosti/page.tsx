...
export default function politikaPrivatnosti() {
  return (
    <section className="mx-5 flex flex-col gap-y-10 lg:mx-[30%]">
      <div>
        <Heading level={2}>Politika privatnosti</Heading>
        <Text>Zadnje ažuriranje: 8. siječnja 2026.</Text>
      </div>
      <div>
      ...
      <div>
        ...
        <Text>
          Podatke koristimo samo da bismo odgovorili na vaš upit. Ne koristimo ih za marketing niti
          ih šaljemo trećim stranama.
        </Text>
      </div>
      <div>
